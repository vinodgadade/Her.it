...
$(document).ready(function () {
    $(".left-image-carousel").slick({ slidesToShow: 1, slidesToScroll: 1, autoplay: !0, autoplaySpeed: 2e3, prevArrow: $(".leftRs"), nextArrow: $(".rightRs") }),
        $(".right-image-carousel").slick({ slidesToShow: 1, slidesToScroll: 1, autoplay: !1, autoplaySpeed: 2e3, prevArrow: $(".right-image-arrow-left"), nextArrow: $(".right-image-arrow-right") }),
        $(".slick-work-carousel-wrap").slick({
            ...
            dots: !1,
            responsive: [
                { breakpoint: 1024, settings: { slidesToShow: 2, slidesToScroll: 2, infinite: !0, dots: !1 } },
        ...
        $(".slick-services-carousel-two-wrap").slick({
            ...
            dots: !1,
            responsive: [
                { breakpoint: 1024, settings: { slidesToShow: 3, infinite: !0, dots: !1 } },
        ...
        $(".slick-testimonial-carousel-wrap").slick({
            ...
            dots: !1,
            responsive: [
                { breakpoint: 998, settings: { slidesToShow: 2, slidesToScroll: 1, infinite: !0, dots: !1 } },
                { breakpoint: 765, settings: { slidesToShow: 1, slidesToScroll: 1 } },
                { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } },
            ],
        }),
        $(".slick-teams-carousel-wrap").slick({
            slidesToShow: 3,
            slidesToScroll: 1,
            autoplay: !0,
            autoplaySpeed: 2e3,
